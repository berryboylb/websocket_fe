  ...
  const accessChat = async (userId: string) => {
    ...
    try {
      ...
      if (!chats.find((c: any) => c._id === data.data._id))
        if (setChats) setChats([data, ...chats]);
      if (data) if (setSelectedChat) setSelectedChat(data.data);
                ...
                notification.map((notif) => (
                  <MenuItem
                    ...
                    onClick={() => {
                      if (notif && notif?.chat)
                        if (setSelectedChat)
                          setSelectedChat(notif?.chat || null);
                      if (setNotification)
                        setNotification(
                  ...
                  >
                    {notif.chat.isGroupChat
                      ...
                      : `New Message from ${
                          user && getSender(user, notif.chat.users)
                        }`}
                  </MenuItem>
                ))}
            </MenuList>
